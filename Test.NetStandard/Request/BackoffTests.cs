...
namespace RudderStack.Test
{
    ...
    class BackoffTests
    {
        ...
        {
            //Arrange
            var backo = new Backoff(jitter: 0);
        ...
        {
            //Arrange
            var backo = new Backoff(jitter: 0, max: max);
        ...
        {
            //Arrange
            var backo = new Backoff(jitter: 0, min: min);
        ...
        {
            //Arrange
            var backo = new Backoff(jitter: 0, factor: factor);
        ...
        {
            //Arrange
            var backo = new Backoff(jitter: jitter);
